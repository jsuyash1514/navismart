...
public class MarinaLandingActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noActivitytextView = view.findViewById(R.id.no_activity_text);
        ...
        liveData.observe(this, dataSnapshot -> {
            if (dataSnapshot != null) {
                ...
                if (dataSnapshot.child("bookings").getChildrenCount() > 0 || dataSnapshot.child("review").getChildrenCount() > 0) {
                    ...
                    Collections.sort(tripletList, (object1, object2) -> (int) (object2.getFirst() - object1.getFirst()));
                        ...
                        if (tripletList.get(i).getSecond() == 1) {
                            ...
                            MarinaActivityModel modelBooking = new MarinaActivityModel(1,
                                    new MarinaActivityNewBookingsCardModel(
                                            ...
                                            dataSnapshot.child("bookings").child(tripletList.get(i).getThird()).child("status").getValue(String.class)
                                    ));
                            list.add(dateModel);
